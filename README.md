# JavaScript 1a Assessment - Coding Portion
...
in the __problems/01-calculator.js__ file by itself, you would run `npm test
test/01-calculator-spec.js`.

Here are the commands to run each of the three test files individually:

```sh
npm test test/01-calculator-spec.js
npm test test/02-debugging-even-numbers-below-spec.js
npm test test/03-highest-average-spec.js
```
